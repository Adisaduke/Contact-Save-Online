...
const Intro = () => {
	...
	return (
		<header id="top" className="header overflow">
			<div>
				<Stars />
			</div>
			<div className="introduction">
				<h1 className="introduction__content">
					<span
						...
						data-aos-once="false"
						className="introduction__content-el introduction__content-el--name"
					>
						Yassine DEHHANI
					</span>
					<span
						...
						data-aos-mirror="false"
						data-aos-once="false"
						className="introduction__content-el introduction__content-el--description"
					>
						Robotics
					</span>
					<span
						...
						data-aos-mirror="false"
						data-aos-once="false"
						className="introduction__content-el introduction__content-el--job"
					>
						Engineer
					</span>
				</h1>
